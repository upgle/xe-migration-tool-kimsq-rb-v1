        ...
        if($target_module == 'module' && !$module_id) {
            ...
            switch($target_module) {
                ...
                case 'module' :
                        ...
                        $query = sprintf("select count(*) as count from %s where bbsid = '%s'", $table_name, $module_id);
                    break;
            }
...
<head>
    ...
    <title>KIMSQ RB v1 data export tool ver 1.0</title>
    <style type="text/css">
...
<body>
    ...
    <form action="./index.php" method="post">
        ...
        <ul>
            <li>
                KIMSQ RB v1 가 설치된 경로를 입력해주세요.

                <blockquote>
                    예1) /home/아이디/public_html/rb<br />
                    예2) ../rb<br />
                </blockquote>
    ...
    <input type="hidden" name="db_type" value="<?php echo $db_type?>" />
        ...
        <blockquote>KIMSQ RB v1는 회원정보와 그외 모듈 종류를 나누어 추출하실 수 있습니다.</blockquote>
            ...
            <li>
                <label for="module">
                    ...
                    <?php
                        ...
                        $id = $module_info->id;
                    ?>
                        <option value="<?php echo $id?>" <?php if($module_id == $id){?>selected="selected"<?php }?>><?php echo $title?> (<?php echo $id?>)</option>
                    <?php 
                        } 
                    ?>
                    </select><br />
    ...
    <input type="hidden" name="db_type" value="<?php echo $db_type?>" />
        ...
        <blockquote>
            ...
            다운을 받지 않고 URL을 직접 XpressEngine 데이터 들여오기 모듈에 입력하여 데이터 이전하실 수도 있습니다.
        </blockquote>
